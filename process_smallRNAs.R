...
#### Processing smallRNA aligmnents
...
#----------------------------------------------------------------------------------------------------
print(paste("Processing",small,"alignments",sep=" "))
...
dir.umap <- paste(base.dir,"/Scratch/",experiment,"/Fastq/unmapped_",small,sep="")
...
source(paste(dir.src,"smallRNA_functions.R",sep="/"))

#-------------------------------------------------------------------------------------------------------------------------
#retrieve smallRNA data
#-------------------------------------------------------------------------------------------------------------------------
setwd(dir.db)
smallRNA <- readDNAStringSet(paste(dir.db,"/",db,".fa",sep=""),format="fasta")

#----------------------------------------------------------------------------------------------------------
# read in alignments of truncated reads to smallRNAs mapped with SHRiMP2 and 
# filter alignments 
